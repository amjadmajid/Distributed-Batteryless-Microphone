...
We have developed a prototype of a \fullcim (\cim): an instant of a \fullsys. The \cim consists of eight battery-less intermittent nodes. Each node is capable of performing isolated words recognition. 
