...
def __node_duty_cycle(ontime, offtime):
    return ontime / __power_cycle_len(ontime, offtime)
    ...
    for cis_idx in range(len(unlabelled_ontime_data)):
        ...
        for node_idx in range(cis_size):
            ...
            for i in range(elem_num):
               node_duty_cycle.append(
                __node_duty_cycle(unlabelled_ontime_data[cis_idx][node_idx][i], 
